...
const Logo = () => {
  ...
  return (
     ...
     */
    <>
     <svg width="190" height="35" viewBox="0 0 118 35" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path
  ...
  />
  <text x="35" y="20" font-family="Arial" font-size="10" fill="black">Customer Loyalty Program</text>
  <defs>
