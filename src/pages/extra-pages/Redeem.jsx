...
export default function Redeem() {
    ...
    const usePoints = async (formPoints, formPartnerId) => {
        try {
            ...
            if (response.data.error) {
                ...
                document.querySelector('.use-partner select').value = '';
                document.querySelector('.usePoints input').value = '';
                document.getElementById('redeemloyalty').innerHTML = '';
            }
        } catch (error) {
            alert("Error: Try again");
            console.error(error);
    ...
    const handlePartnerChange = async (event) => {
        try {
            ...
            setLoyaltyOptions(transactionData.map(option => ({
                ...
                text: ` ${option.item} for $${option.points}`,
            })));
        } catch (error) {
                                        ...
                                        >
                                            {({ handleSubmit, setFieldValue }) => (
                                                <Form id="exampleFormTopLabels" className="tooltip-right-bottom" noValidate onSubmit={handleSubmit}>
                                                    <BootstrapForm.Group controlId="formDropdown" className="form-group has-float-label use-partner">
                                                        <BootstrapForm.Label>Choose Partner to Reedem Points</BootstrapForm.Label><br />
                                                        <Field
                                                            as="select"
                                                            name="dropdown"
                                                    ...
                                                    <BootstrapForm.Group className="form-group has-float-label" id="redeemloyalty">
                                                    ...
                                                    <BootstrapForm.Group controlId="formPoints" className="form-group has-float-label usePoints">
                                                        <BootstrapForm.Label>Reedem Points for an Item</BootstrapForm.Label> <br />
                                                        <Field
                                                            name="points"
                                                    ...
                                                    <Button type="submit" variant="primary" className="btn btn-primary use-points-transaction">
                                                        Purchase and Earn
                                                    </Button>
                                                </Form>
                                            )}
